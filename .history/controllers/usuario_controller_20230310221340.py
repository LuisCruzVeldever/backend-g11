...
class LoginController(Resource):
    def post(self):
        ...
        try:
            ...
            if resultado:
                #identity > sirve para indicar a que usario le pertenece esta JWT
...
class PerfilController(Resource):
    # al poner ese decorador ahora tiene que ser obligatorio al pasar la token
    @jwt_required()
    def get(self):
        ...
        usuario_encontrado:Usuario = query.filter_by(i = id).first()
