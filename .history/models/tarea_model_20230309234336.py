...
# Para cuando nosotros queremos usar un enumerable en una columna de la bd tenemos que crear una clase definiedo esos enumerables
...
class Tarea(conexion.Model):
    ...
    usuario_Id = Column(ForeignKey(column='usuarios.id'), type_=types.
    Integer, nullable=False, name ='usuario_id')
